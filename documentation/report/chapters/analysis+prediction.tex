...
\end{tabular}
\label{table:kpss}
\caption{Table of results of KPSS-test of stationarity on the sample series: Price of "Jyoti" Potato in West Bengal. A p-value less than 0.05 indicates a rejection of the null hypothesis that the series is stationary under the 95\% confidence level. \cite{kwiat}}
\end{table}
...
\subsection*{Neural networks - introduction \footnotesize\emph{Stefan Mihaila}}
...
\subsection*{Feed Forward Neural Networks - Multilayer Perceptrons \footnotesize\emph{Stefan Mihaila}}
...
\subsection*{Feed Forward Neural Networks - models used \footnotesize\emph{Stefan Mihaila}}
