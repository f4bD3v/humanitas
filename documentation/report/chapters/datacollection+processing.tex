...
>>>>>>> 66ed924448ab7eed07dead70175e5b7c03ffc33f
...
<<<<<<< HEAD
To get as many tweets as possible associated with a location we decided to use the locations of user accounts as a simple heuristic. We created a mapping between city and region names and used it to identify valid locations, which were then used during later processing.
=======
\emph{Gabriel Grill} \\
