...
export SPARK_MASTER_IP=100.88.212.18
" >> .bashrc
...
mvn package
cp target/hive-cassandra-1.2.9.jar ../../hive-0.9.0-bin/lib/
cp target/dependency/cassandra-thrift-1.2.9.jar ../../hive-0.9.0-bin/lib/
cp target/dependency/cassandra-all-1.2.9.jar ../../hive-0.9.0-bin/lib/
